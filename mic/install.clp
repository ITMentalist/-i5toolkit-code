...
/******************************************************************************/
/* @file install.clp                                                          */
/* Create symbolic links for QShell commands of the project.                  */
/******************************************************************************/
...
QSH:
             ...
             /* lsobjtypes */
             RMVLNK     OBJLNK('/usr/bin/lsobjtypes')
             MONMSG     MSGID(CPF0000)
             ADDLNK     +
                          OBJ('/qsys.lib/i5toolkit.lib/lsobjtypes.pgm+
                          ') NEWLNK('/usr/bin/lsobjtypes')
