...
/*  AUTHOR   - Gene Gaunt                                           */
/*                                                                  */
/*  @remark The following VRM-dependent offset values are VRM540    */
/*          specific:                                               */
/*  - Offset to built-in name section: hex 22B0                     */
/*  - Offset to built-in code section: hex 39A0                     */
/********************************************************************/
...
name = walk + x2d( 22B0 ) /* Offset to built-in name section at VRM540 */
code = walk + x2d( 39A0 ) /* Offset to built-in code section at VRM540 */
do while walk < name
